...
The project is built with \textbf{CMake 4.1} \cite{CMakeDocs} and targets the \textbf{C11} language standard \cite{C11Standard}. Before building, the following tools must be present on the host machine:
